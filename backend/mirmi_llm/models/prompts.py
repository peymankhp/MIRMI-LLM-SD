...
from mirmi_llm.models.prompt_history import PromptHistories
from mirmi_llm.models.access_grants import AccessGrantModel, AccessGrants
...
class PromptsTable:
    ...
    def search_prompts(
        ...
        with get_db_context(db) as db:
            from mirmi_llm.models.users import User, UserModel
