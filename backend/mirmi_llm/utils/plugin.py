...
from mirmi_llm.env import PIP_OPTIONS, PIP_PACKAGE_INDEX_OPTIONS, OFFLINE_MODE
...
def replace_imports(content):
    ...
    """
    replacements = {
        "from utils": "from mirmi_llm.utils",
        "from apps": "from mirmi_llm.apps",
        "from main": "from mirmi_llm.main",
        "from config": "from mirmi_llm.config",
    }
