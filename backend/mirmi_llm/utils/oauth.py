...
from mirmi_llm.models.auths import Auths
from mirmi_llm.models.oauth_sessions import OAuthSessions
from mirmi_llm.models.users import Users


from mirmi_llm.models.groups import Groups, GroupModel, GroupUpdateForm, GroupForm
...
from mirmi_llm.utils.misc import parse_duration
from mirmi_llm.utils.auth import get_password_hash, create_token
...
from mirmi_llm.env import GLOBAL_LOG_LEVEL
...
class OAuthManager:
    ...
    def update_user_groups(self, user, user_data, default_permissions, db=None):
        ...
        log.debug(
            f"All groups available in MIRMILLM: {[g.name for g in all_available_groups]}"
        )
