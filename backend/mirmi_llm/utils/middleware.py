...
from mirmi_llm.utils.misc import is_string_allowed
from mirmi_llm.models.oauth_sessions import OAuthSessions
from mirmi_llm.models.chats import Chats
from mirmi_llm.models.folders import Folders
from mirmi_llm.models.users import Users
from mirmi_llm.socket.main import (
    get_event_call,
    get_event_emitter,
)
from mirmi_llm.routers.tasks import (
    generate_queries,
    generate_title,
    generate_follow_ups,
...
from mirmi_llm.utils.tools import get_builtin_tools
from mirmi_llm.routers.images import (
    image_generations,
    CreateImageForm,
    image_edits,
    EditImageForm,
)
from mirmi_llm.routers.pipelines import (
    process_pipeline_inlet_filter,
    process_pipeline_outlet_filter,
)
from mirmi_llm.routers.memories import query_memory, QueryMemoryForm

from mirmi_llm.utils.webhook import post_webhook
from mirmi_llm.utils.files import (
...
from mirmi_llm.models.users import UserModel
from mirmi_llm.models.functions import Functions
from mirmi_llm.models.models import Models

from mirmi_llm.retrieval.utils import get_sources_from_items


from mirmi_llm.utils.sanitize import sanitize_code
from mirmi_llm.utils.chat import generate_chat_completion
from mirmi_llm.utils.task import (
    get_task_model_id,
    rag_template,
...
from mirmi_llm.utils.tools import (
    get_tools,
    get_updated_tool_function,
    has_tool_server_access,
)
from mirmi_llm.utils.plugin import load_function_module_by_id
from mirmi_llm.utils.filter import (
    get_sorted_filter_ids,
    process_filter_functions,
)
from mirmi_llm.utils.code_interpreter import execute_code_jupyter
from mirmi_llm.utils.payload import apply_system_prompt_to_body
from mirmi_llm.utils.response import normalize_usage
from mirmi_llm.utils.mcp.client import MCPClient
...
from mirmi_llm.utils.headers import include_user_info_headers
from mirmi_llm.constants import TASKS
...
def serialize_output(output: list) -> str:
    ...
    for idx, item in enumerate(output):
        ...
        elif item_type == "mirmi_llm:code_interpreter":
...
async def process_chat_payload(request, form_data, user, metadata, model):
    ...
    available_skills = []
    if all_skill_ids:
        from mirmi_llm.models.skills import Skills as SkillsModel
        ...
        async def response_handler(response, events):
            def tag_output_handler(content_type, tags, output):
                ...
                output_type_map = {
                    ...
                    "code_interpreter": "mirmi_llm:code_interpreter",
                }
                ...
                if last_type == "message":
                    ...
                    for start_tag, end_tag in tags:
                        ...
                        if match:
                            ...
                            elif output_item_type == "mirmi_llm:code_interpreter":
                                output.append(
                                    {
                                        "type": "mirmi_llm:code_interpreter",
                                        "id": output_id("ci"),
                                        "status": "in_progress",
                                        "start_tag": start_tag,
                                        "end_tag": end_tag,
                    ...
                    or (
                        last_type == "mirmi_llm:code_interpreter"
                    ...
                    elif last_type == "mirmi_llm:code_interpreter":
            ...
            try:
                ...
                if DETECT_CODE_INTERPRETER:
                    ...
                    while (
                        output
                        and output[-1].get("type") == "mirmi_llm:code_interpreter"
