from mirmi_llm.utils.task import prompt_template, prompt_variables_template
...
def remove_mirmi_llm_params(params: dict) -> dict:
    """
    Removes MIRMILLM specific parameters from the provided dictionary.

    Args:
        params (dict): The dictionary containing parameters.

    Returns:
        dict: The modified dictionary with MIRMILLM parameters removed.
    """
    mirmi_llm_params = {
...
def apply_model_params_to_body_openai(params: dict, form_data: dict) -> dict:
    params = remove_mirmi_llm_params(params)
