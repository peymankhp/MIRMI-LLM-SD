...
from mirmi_llm.retrieval.loaders.external_document import ExternalDocumentLoader

from mirmi_llm.retrieval.loaders.mistral import MistralLoader
from mirmi_llm.retrieval.loaders.datalab_marker import DatalabMarkerLoader
from mirmi_llm.retrieval.loaders.mineru import MinerULoader


from mirmi_llm.env import GLOBAL_LOG_LEVEL, REQUESTS_VERIFY
    ...
    def _get_loader(self, filename: str, file_content_type: str, file_path: str):
        ...
        if (
            ...
            if not api_base_url or api_base_url.strip() == "":
                api_base_url = "https://www.datalab.to/api/v1/marker"  # https://github.com/mirmi-llm/mirmi-llm/pull/16867#issuecomment-3218424349
