...
from mirmi_llm.routers.retrieval import ProcessFileForm, process_file
from mirmi_llm.routers.audio import transcribe

from mirmi_llm.storage.provider import Storage


from mirmi_llm.utils.auth import get_admin_user, get_verified_user
from mirmi_llm.utils.misc import strict_match_mime_type
...
def upload_file_handler(
    ...
    try:
        ...
        contents, file_path = Storage.upload_file(
            ...
            filename,
            {
                "MIRMILLM-User-Email": user.email,
                "MIRMILLM-User-Id": user.id,
                "MIRMILLM-User-Name": user.name,
                "MIRMILLM-File-Id": id,
            },
        )
