...
# 4. Replace "mirmi_llm" with "mirmi_llm"
echo ""
echo "Step 4: Replacing 'mirmi_llm' with 'mirmi_llm'..."
replace_in_files "mirmi_llm" "mirmi_llm" "'mirmi_llm' → 'mirmi_llm'"
...
if [ -f "backend/mirmi_llm/env.py" ]; then
    mv backend/mirmi_llm backend/mirmi_llm 2>/dev/null || true
fi
