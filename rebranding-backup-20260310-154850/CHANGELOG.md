...
- ☁️ OneDrive integration was improved to support separate client IDs for personal and business authentication, enabling both integrations to work simultaneously. [#17619](https://github.com/mirmi-llm/mirmi-llm/pull/17619), [Docs](https://docs.openwebui.com/tutorials/integrations/onedrive-sharepoint), [Docs](https://docs.openwebui.com/getting-started/env-configuration/#onedrive)
...
- 📜 **Custom License Update & Contributor Agreement**: MIRMI LLM now operates under a custom license with Contributor License Agreement required by default—see https://docs.openwebui.com/license/ for details, ensuring sustainable open innovation for the community.
...
- **🔧 Additional Environment Variables**: Discover more environment variables in our comprehensive documentation at MIRMI LLM Documentation (https://docs.openwebui.com).
...
- Access our comprehensive documentation at [MIRMI LLM Documentation](https://docs.openwebui.com/).
