	...
	>
		...
		>
			...
			<div class="-mt-[0.5px]">
				...
				<div>
					<Tooltip content={$i18n.t('Image Generator')} placement="right">
						<a
							class=" cursor-pointer flex rounded-xl hover:bg-gray-100 dark:hover:bg-gray-850 transition group"
							...
							on:click={async (e) => {
								...
								goto('/image-generator');
								itemClickHandler();
							}}
							aria-label={$i18n.t('Image Generator')}
						>
							<div class=" self-center flex items-center justify-center size-9">
								<svg
		...
		>
			...
			>
				<div class="pb-1.5">
					...
					<div class="px-[0.4375rem] flex justify-center text-gray-800 dark:text-gray-200">
						<a
							id="sidebar-image-generator-button"
							class="group grow flex items-center space-x-3 rounded-2xl px-2.5 py-2 hover:bg-gray-100 dark:hover:bg-gray-900 transition outline-none"
							href="/image-generator"
							draggable="false"
							on:click={async (e) => {
						...
						>
							...
							<div class="flex flex-1 self-center translate-y-[0.5px]">
								<div class=" self-center text-sm font-primary">{$i18n.t('Image Generator')}</div>
							</div>
						</a>
					</div>
					...
					<div class="px-[0.4375rem] flex justify-center text-gray-800 dark:text-gray-200">
						...
						>
							<div class="self-center">
								<Code strokeWidth="2" className="size-4.5" />
							</div>

							<div class="flex flex-1 self-center translate-y-[0.5px]">
								<div class=" self-center text-sm font-primary">{$i18n.t('IDE')}</div>
							</div>
						</a>
					</div>
