...
<div
	class="flex flex-col h-screen w-full bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200"
>
	<!-- Header -->
	...
	<div class="flex-1 overflow-y-auto px-4 py-6">
		{#if images.length === 0 && !loading}
			<div
				class="flex flex-col items-center justify-center h-full gap-3 text-gray-400 dark:text-gray-600"
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					fill="none"
		...
		{#if loading}
			<div class="flex flex-col items-center justify-center py-16 gap-4">
				<div class="relative size-16">
					<div
						class="absolute inset-0 rounded-full border-4 border-purple-200 dark:border-purple-900"
					></div>
					<div
						class="absolute inset-0 rounded-full border-4 border-transparent border-t-purple-500 animate-spin"
					></div>
				</div>
		...
		{#if images.length > 0}
			<div class="max-w-3xl mx-auto space-y-6">
				{#each images as img, i}
					<div
						class="rounded-2xl overflow-hidden border border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-850"
					>
						<img src={img.url} alt={img.prompt} class="w-full object-contain max-h-[70vh]" />
	...
	<div class="shrink-0 border-t border-gray-100 dark:border-gray-800 px-4 py-4">
		<div class="max-w-3xl mx-auto">
			...
			{#if showAdvanced}
				<div
					class="mb-3 grid grid-cols-2 sm:grid-cols-3 gap-2 p-3 rounded-xl bg-gray-50 dark:bg-gray-850 border border-gray-100 dark:border-gray-800"
				>
			...
			<!-- Prompt input -->
			<div
				class="flex items-end gap-2 rounded-2xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-850 px-4 py-3 focus-within:border-purple-400 dark:focus-within:border-purple-600 transition"
			>
				<textarea
